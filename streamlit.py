...
# Home page setting
if web == "Home":
    slt.image("rdc-redbus-logo.svg", width=200)
    ...
    slt.subheader(":blue[Developed-by:]  Josh Williams R")
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="Sql@0783",
